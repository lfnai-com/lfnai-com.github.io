window.onload = function (){
			document.getElementById("video_popup_1").onclick = function () {video_popup_1();};
};


function video_popup_1() {
Swal.fire({
...
<div class="contenedor">
		<small>
				<a class="btn btn-primary" href="#" target="iframevideopopup">texto</a>
				<a class="btn btn-primary">00:00</a>
